...
public class TicketAdapter extends RecyclerView.Adapter <TicketAdapter.MyViewHolder>{
    ...
    public void onBindViewHolder(@NonNull MyViewHolder myViewHolder, int i) {
        ...
        myViewHolder.xjumlah_tiket.setText(myTicket.get(i).getJumlah_tiket() + " Ticket(s)");
        ...
        myViewHolder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent toMyticketDetails = new Intent(context, MyTicketDeatilsActivity.class);
                toMyticketDetails.putExtra("nama_wisata", getNamaWisata);
                context.startActivity(toMyticketDetails);
            }
        });
